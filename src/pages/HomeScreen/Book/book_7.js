            ...
            <View style={{flex:1}}>
                <LinearGradient style={{ flex: 1 }} colors={[global.mainColor, "#fff", "#fff"]}>
                    ...
                    <View style={{flexDirection:'row',alignItems:"center",backgroundColor:'#fff',elevation:5,justifyContent:'space-around'}}>
                        ...
                        <TouchableOpacity activeOpacity={1} style={{elevation:5,justifyContent:'center',backgroundcolor:global.mainColor,borderRadius:20,width:width*0.4,alignItems:"center",height:height*0.06}}  onPress={()=>this.props.navigation.navigate('book_xiangqing_7',{k:0})}>
