                ...
                <LinearGradient style={{ flex: 1 }} colors={[global.back2, "#fff", "#fff"]}>
                    ...
                    <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:20}}>
                        <View style={{marginLeft:width*0.05}}>
                            <Text style={{marginTop:20,fontSize:18,color:'#fff'}}>中国共产党历史第一卷（上册）</Text>
                            <Text style={{marginTop:20,color:'#fff',fontSize:13}}>中共中央党史研究室</Text>
                        </View>
                        <Image source={{uri:'https://bkimg.cdn.bcebos.com/pic/a08b87d6277f9e2fbfd2794a1130e924b999f389?x-bce-process=image/resize,m_lfit,w_268,limit_1/format,f_jpg'}} style={{height:150,width:100,marginRight:width*0.05}}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row',alignItems:"center",backgroundColor:'#fff',elevation:5,justifyContent:'space-around'}}>
                        ...
                        <TouchableOpacity activeOpacity={1} style={{elevation:5,justifyContent:'center',backgroundcolor:global.back2,borderRadius:20,width:width*0.4,alignItems:"center",height:height*0.06}}  onPress={()=>this.props.navigation.navigate('book_xiangqing_0',{k:0})}>
