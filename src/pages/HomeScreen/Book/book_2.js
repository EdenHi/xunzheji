...
export default class book_2 extends Component {
                ...
                <LinearGradient style={{ flex: 1 }} colors={[global.mainColor, "#fff", "#fff"]}>
                    ...
                    <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:20}}>
                        <View style={{marginLeft:width*0.05}}>
                            <Text style={{marginTop:20,fontSize:18,color:'#fff'}}>徐冠巨：勇立潮头</Text>
                            <Text style={{marginTop:20,color:'#fff',fontSize:13}}>吴晓波</Text>
                        </View>
                    ...
                    <View style={{flexDirection:'row',alignItems:"center",backgroundColor:'#fff',elevation:5,justifyContent:'space-around'}}>
                        ...
                        <TouchableOpacity activeOpacity={1} style={{elevation:5,justifyContent:'center',backgroundColor:global.mainColor,borderRadius:20,width:width*0.4,alignItems:"center",height:height*0.06}}  onPress={()=>this.props.navigation.navigate('book_xiangqing_2',{k:0})}>
