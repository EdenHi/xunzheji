    ...
    renderDate({item,index}){
        return(
            <TouchableOpacity onPress={()=>this.context.navigate('LiuYu',item)} key={index}>
                <View style={{ flexDirection: "row", marginBottom: 10, width: width * 0.9, height: 150, borderWidth: 1, justifyContent: "center", alignItems: "center", borderStyle: "dashed", borderColor: global.mainColor, borderRadius: 10 }}>
