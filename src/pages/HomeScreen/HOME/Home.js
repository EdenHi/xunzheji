                        ...
                        <ScrollView
                            ...
                            <View style={{ width: width * 0.95 }}>
                                ...
                                <View style={{ height: height * 0.4, backgroundColor: global.backColor, borderRadius: 10, marginTop: 10 }} >
                                    ...
                                    {/* book top */}
                                    <TouchableOpacity activeOpacity={1} onPress={() => this.props.navigation.navigate("book_0", { id: bookList[this.state.BookList[0]].id })} style={{ height: height * 0.4 * 0.4, borderTopRightRadius: 10, borderTopLeftRadius: 10, flexDirection: 'row' }}>
                                        ...
                                        <View style={{ borderColor: 'green', width: '72.5%', marginLeft: '3.15%' }}>
                                            <Text style={{ fontSize: 18, marginTop: height * 0.01, color: global.mainColor == '#145A59' ? '#fff' : "#333" }}numberOfLines={1}>{bookList[this.state.BookList[0]].bookname}</Text>
                                            <Text style={{ marginTop: height * 0.02, color: global.mainColor == '#145A59' ? '#fff' : "#333" }} numberOfLines={2}>{bookList[this.state.BookList[0]].jianjie}</Text>
                                    ...
                                    <View style={{ height: height * 0.4 * 0.46, borderBottomLeftRadius: 10, borderBottomRightRadius: 10, flexDirection: 'row' }}>
                                        <TouchableOpacity activeOpacity={1} onPress={() => this.props.navigation.navigate("book_0", { id: bookList[this.state.BookList[1]].id })} style={{ width: '22%', borderColor: 'red', height: '100%', marginLeft: '2.5%' }}>
                                        ...
                                        {/* 2 */}
                                        <TouchableOpacity activeOpacity={1} onPress={() => this.props.navigation.navigate("book_0", { id: bookList[this.state.BookList[2]].id })} style={{ width: '22%', borderColor: 'red', height: '100%', marginLeft: '2.5%' }}>
                                            <View style={{ width: '95%', height: '70%', marginTop: 5, marginLeft: '2.5%' }}>
                                        ...
                                        {/* 3 */}
                                        <TouchableOpacity activeOpacity={1} onPress={() => this.props.navigation.navigate("book_0", { id: bookList[this.state.BookList[3]].id })} style={{ width: '22%', borderColor: 'red', height: '100%', marginLeft: '2.5%' }}>
                                            <View style={{ width: '95%', height: '70%', marginTop: 5, marginLeft: '2.5%' }}>
                                        ...
                                        {/* 4 */}
                                        <TouchableOpacity  activeOpacity={1}onPress={() => this.props.navigation.navigate("book_0", { id: bookList[this.state.BookList[4]].id })} style={{ width: '22%', borderColor: 'red', height: '100%', marginLeft: '2.5%' }}>
                                            <View style={{ width: '95%', height: '70%', marginTop: 5, marginLeft: '2.5%' }}>
