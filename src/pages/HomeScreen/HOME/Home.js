                  ...
                  <ShiCha/>
                     ...
                     <View style={{width:width * 0.95,height:480,backgroundColor:'white',borderRadius:10,marginTop:10,elevation:3,shadowRadius:20,justifyContent:'center'}} >
                         ...
                         <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',padding:10,paddingTop:-10}}>
                             <View style={{backgroundColor:'#7cc0bf',width:2,height:28}} /><Text style={{fontSize:15,fontWeight:'bold',color:'#7cc0bf'}}>浙商历史推荐</Text>
                                     ...
                                     <TouchableOpacity onPress={()=>this.props.navigation.navigate('Book')}>
                                           <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',padding:10}}>
                                               <View style={{backgroundColor:'#7cc0bf',width:2,height:28}} />
                                                    <Text style={{fontSize:15,color:'#7cc0bf',fontWeight:'bold'}}>浙商必知丛书</Text>
                    ...
                    <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
                             <View style={{backgroundColor:'#7cc0bf',width:2,height:28}} /><Text style={{fontSize:15,fontWeight:'bold',color:'#7cc0bf'}}>浙商人物介绍</Text><TouchableOpacity style={{ width: width * 0.08, height: width * 0.08,marginLeft: '60%' ,color:'#7cc0bf'}}>
                             <AntDesign style={{ textAlign: 'center',textAlignVertical:'center',height:'100%',color:'#7cc0bf' }} name="right" size={20} color="#000000" />
                             </TouchableOpacity></View>
