...
export default class Characters extends Component {
    render() {
        return (
                ...
                <ImageBackground borderRadius={10} style={{height:180,width:width*0.3,}} source={{uri:'http://47.100.78.254:3000/public/images/blue.jpeg'}}>
                                     <View style={{alignItems:"center",justifyContent:"center",}} > 
                                         <Image style={{height:width*0.2, width:width*0.2, borderRadius:100,alignContent:"center",marginTop:10}} source={{uri:"http://47.100.78.254:3000/public/images/my.jpg"}}/>
