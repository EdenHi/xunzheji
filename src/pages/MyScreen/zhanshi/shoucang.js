...
export default class shoucang extends Component {
    ...
    renderData({item,index}){
        return (
            <View key={index}>
                <ImageBackground style={{height:150,marginBottom:10,width:width * 0.8,marginRight:20}} borderRadus={10} source={{uri:'http://47.100.78.254:3000/public/images/zs1.jpeg'}}>
        ...
        return (
            <View style={{width:width * 0.9,marginLeft:width * 0.05}}>
                ...
                {/* <FlatList
                 ...
                 <ImageBackground style={{height:150,marginTop:10}} borderRadius={10} source={{uri:'http://47.100.78.254:3000/public/images/zs1.jpeg'}}>
                    <View style={{height:150,borderRadius: 10,shadowRadius:15,padding:15,width:width * 0.8}}>
                        <View style={{flex:3}} />
                        <View style={{flex:2}}><Text style={{fontSize:22,fontWeight:'bold',color:'#fff'}}>浙江商帮的崛起</Text></View>
                        <View style={{flex:1}}>
