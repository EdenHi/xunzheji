...
import {View,Text, ScrollView, FlatList,AsyncStorage,Dimensions,ImageBackground,TouchableOpacity} from 'react-native';
...
export default class shhoucang extends Component {
    ...
    get_shuju(){
        fetch('http://192.168.50.117:3000/index/selectShoucang', {
            method: 'POST',
            headers: {
