...
export default class Wallet extends Component {
    ...
    _renderItem = ({ item }) => (
        <View style={{ width: width * 0.97, alignSelf: 'center', height: height * 0.1, backgroundColor: '#fff', flexDirection: 'row', marginVertical: height * 0.0025 }}>
            ...
            <Image style={{ width: '20%', height: '100%' }} source={{ uri: 'http://47.100.78.254:3000/images/1.jpg' }} ></Image>
            <View style={{ width: '60%' }}>
                ...
                <Text style={{ height: '50%', fontSize: 15, paddingLeft: width * 0.1, textAlignVertical: 'top', color: 'grey' }}>{item.consume == null ? "充值" + item.invest : "消费" + item.consume}</Text>
            </View>
        </View>
    );
    componentWillMount() {
    ...
    chongzhi(){
        ...
        }), this.setState({ money: 200 + this.state.money })
    }
    render() {
            ...
            <View style={{
                ...
                <Modal
                        ...
                        >
                            ...
                            <View style={{backgroundColor:'rgba(0,0,0,0.5)',flex:1}}>
                                <View style={{width:width*0.8,marginLeft:width*0.1,height:height*0.33,backgroundColor:'#fff',marginTop:height*0.3,borderRadius:15,}}>
                                    ...
                                    <TextInput style={{textAlign:'center',fontSize:30,color:'#000',fontWeight:'bold',marginTop:height*0.01}}></TextInput>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Text style={{ fontSize: 16, height: height * 0.05, color: '#333', paddingLeft: width * 0.05 }}>交易记录</Text>
                        <Text onPress={() => {
                           this._openModalWin()
