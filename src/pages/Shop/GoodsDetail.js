...
<View style={{ borderBottomRightRadius:10,borderBottomLeftRadius:10,elevation:5, height: height * 0.15, width: width, backgroundColor: '#eee',width: "100%" }}>
        ...
        {/* 头部 */}
        <View style={{flexDirection:"row",alignItems:"center",backgroundColor:global.mainColor,height:height*0.07,justifyContent:"space-around"}}> 
              <TouchableOpacity activeOpacity={1} style={{ }}>
                  <AntDesign onPress={()=>this.props.navigation.goBack()} style={{textAlignVertical:'center',height:"100%",color:"#fff" }} name="left" size={20} color="#000000" />
              </TouchableOpacity>
            ...
            }} name="dots-three-vertical"  color={global.mainColor}  size={20} />
            </View> 
