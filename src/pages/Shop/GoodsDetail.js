        ...
        return (
            <View style={styles.Box1}>
                ...
                <View style={styles.Head}>
                    <Entypo onPress={() => { this.props.navigation.goBack() }}
                ...
                <ScrollView style={{ borderWidth: 0, }}>
                    ...
                    <View style={{ width: "85%", marginHorizontal: "7.5%", borderRadius: 20, }}>
                        <View style={{ borderWidth: 0, height: height * 0.05, flexDirection: 'row', borderBottomWidth: 0.5, borderColor: 'grey', backgroundColor: '#fff' }}>
                            <Text style={{ borderWidth: 0, textAlignVertical: 'center', height: '100%', fontSize: 18, fontWeight: 'bold' }}>尺寸</Text>
                            <Text style={{ borderWidth: 0, textAlignVertical: 'center', color: 'grey', width: width * 0.71, fontSize: 13, marginLeft: width * 0.116 }}>1000000km*5m</Text>
                        </View>
                    ...
                    <View style={{ height: "5%", borderWidth: 1, borderRadius: 10, }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around', height: '100%' }}>
                            ...
                            <View style={{ borderWidth: 0, width: '35%', }}>
                                ...
                                <Text style={{ width: '100%', height: '50%', textAlign: 'center', fontSize: 20 }}>评分</Text>
                ...
                <View style={styles.Foot}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-around', width: "40%" }}>
                        ...
                        <View style={{ flexDirection: 'column', borderWidth: 0, alignSelf: 'center' }}>
                            <Entypo style={{ borderWidth: 0, marginTop: "15%" }}
                                name="shop"
                                size={25}
                            />
                            <Text style={{ fontSize: 10, alignSelf: 'center', marginTop: "-5%", borderWidth: 0 }}>店铺</Text>
                        </View>
                        <View style={{ flexDirection: 'column', alignSelf: 'center' }}>
                            <Entypo style={{ borderWidth: 0, marginTop: "15%" }}
                                ...
                                size={25}
                            />
                            <Text style={{ fontSize: 10, alignSelf: 'center', marginTop: "-5%", borderWidth: 0 }}>背包</Text>
                        </View>

                    </View>

                    <TouchableOpacity activeOpacity={1} style={{ borderWidth: 0, width: '27.5%', height: '90%', backgroundColor: 'black', borderTopLeftRadius: 30, borderBottomLeftRadius: 30, marginTop: "1%" }}>
                        <Text style={{ color: '#fff', fontSize: 18, textAlignVertical: 'center', height: '100%', textAlign: 'center' }}>加入购物车</Text>
                    </TouchableOpacity>
                    <TouchableOpacity activeOpacity={1} style={{ borderWidth: 0, width: '27.5%', height: '90%', backgroundColor: 'black', borderTopRightRadius: 30, borderBottomRightRadius: 30, marginTop: "1%" }}>
                        <Text style={{ color: '#fff', fontSize: 18, textAlignVertical: 'center', height: '100%', textAlign: 'center' }}>立即购买</Text>
                    </TouchableOpacity>
                </View>
