          ...
          <SwipeRow
            ...
            <View style={styles.cellStyle}>
              ...
              <View style={{justifyContent: commonStyle.around, flex: 1, marginHorizontal: 10, height: 50}}>
                ...
                <Text style={{fontSize: 13,color:global.mainColor,marginTop:30}}>{`￥${item.itemPrice}`}</Text>
              </View>
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <View style={{width:width,height:height*0.07,backgroundColor:global.mainColor,flexDirection:"row",alignItems:"center"}}>
        ...
        <View style={styles.toolBar}>
          ...
          <Text style={{marginHorizontal: 10,color:"#333333"}}>合计:
            <Text style={{color:global.mainColor}}>￥{parseFloat(this.state.totalPrice).toFixed(2)}</Text>
          </Text>
          <View style={{width: 120,backgroundColor:global.mainColor, alignItems: commonStyle.center, justifyContent: commonStyle.center, height: commonStyle.cellHeight}}>
