            ...
            return(
                <View style={{ marginHorizontal: width * 0.05, backgroundColor: "#fff", padding: 5, elevation: 5, borderRadius: 10,marginBottom:10 }} key={index}>
                   ...
                   {item.fahuo ==='未发货' ?<View style={{ flexDirection: "row", flexDirection:"row-reverse" }}>
                        ...
                        <TouchableOpacity  onPress={()=>this.setState({vv:item.id,modalVisible: true,kk:item})} style={{ justifyContent: "center", alignItems: "center", width: 80, height: height*0.04, borderWidth: 1, borderRadius: 20, marginLeft: 10, borderColor: global.mainColor }}><Text style={{ fontSize: 14, color: global.mainColor }}>确认收货</Text></TouchableOpacity>
                                    ...
                                    >
                                        <View style={styles.modalContainer}>
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={{ fontSize: 20, color: global.mainColor }}>收货成功</Text>
                                            </View>
                                            ...
                                            >
                                                <Text style={{ fontSize: 15,color:global.mainColor }}>去评论</Text>
                                            </TouchableOpacity>
                                            </View>
                                        </View>
                                    </TouchableOpacity>
