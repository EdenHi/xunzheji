        ...
        if (this.state.arr != null && this.state.arr.length >= 1) {
            ...
            return (
                <TouchableOpacity activeOpacity={1}
                    ...
                    <Image source={{uri:'http://8.142.11.85:3000/public/images/addimg.png'}}
                ...
                colors={["#7cc0bf", "#fff", "#fff"]}>
                    <View style={{ width: width * 0.9, marginLeft: width * 0.05, marginRight: width * 0.05, height }}> 
                        <View style={{flexDirection: "row", alignItems: "center", height: height * 0.07,justifyContent:'space-between'}} >
                            <TouchableOpacity activeOpacity={1}
                                style={{}}>
                                <AntDesign onPress={() => this.props.navigation.goBack()}
                                    style={{textAlignVertical: 'center', height: "100%", color: "#fff" }}
                                    name="left"
                                    size={20}
                                    color="#000000" />
                            </TouchableOpacity>
                        ...
                        <ScrollView style={{ height: height * 0.9 }}
                            ...
                            <Text style={{marginTop: 10, fontSize: 18, fontWeight: 'bold' }}>可定制项目
                            </Text>
                            <ScrollView horizontal showsHorizontalScrollIndicator={false}
                                style={{ marginTop: 10 }}>
                                <View>
                                    <TouchableOpacity activeOpacity={1}
                                        style={{ borderRadius: 10, borderColor: this.state.isXiangmu0 ? 'orange' : 'rgba(0,0,0,0)',borderWidth: 1}}
                                        onPress={() => this.isXiangmu(0)}>
                                        <Image style={{height: width * 0.35, width: width * 0.35, margin: 2, borderRadius: 10 }}
                                            source={{uri: this.props.route.params.msg.img}}/>
                                    </TouchableOpacity >
                                    <Text style={{marginTop: 5, color: this.state.isXiangmu0 === false ? 'black' : 'orange' }}>{this.props.route.params.msg.title}
                                    </Text>
                                </View >
                                <View >
                                    <TouchableOpacity activeOpacity={1}
                                        style={{ borderRadius: 10, borderColor: this.state.isXiangmu1 ? 'orange' : 'rgba(0,0,0,0)', borderWidth: 1 }}
                                        onPress={() => this.isXiangmu(1)}>
                                        <Image style={{ height: width * 0.35, width: width * 0.35, margin: 2, borderRadius: 10 }}
                                            source={{ uri: 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fp6.itc.cn%2Fimages01%2F20200805%2Fd160acc7ccc54543ae96306cf689aa1b.jpeg&refer=http%3A%2F%2Fp6.itc.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1632013127&t=92366525746964222404ebe301bee1ac'}}/>
                                    </TouchableOpacity >
                                    <Text style={{ marginTop: 5, color: this.state.isXiangmu1 === false ? 'black' : 'orange' }}>玉兰花
                                    </Text>
                                </View >
                                <View >
                                    <TouchableOpacity activeOpacity={1}
                                        style={{ borderRadius: 10, borderColor: this.state.isXiangmu2 ? 'orange' : 'rgba(0,0,0,0)', borderWidth: 1 }}
                                        onPress={() => this.isXiangmu(2)} >
                                        <Image style={{ height: width * 0.35, width: width * 0.35, margin: 2, borderRadius: 10 }}
                                            source={{ uri: 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fp6.itc.cn%2Fimages01%2F20200805%2Fd160acc7ccc54543ae96306cf689aa1b.jpeg&refer=http%3A%2F%2Fp6.itc.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1632013127&t=92366525746964222404ebe301bee1ac'}}/>
                                    </TouchableOpacity >
                                    <Text style={{marginTop: 5, color: this.state.isXiangmu2 === false ? 'black' : 'orange' }}>黄杨木摆件
                                    </Text>
                                </View >
                            </ScrollView>
                            ...
                            <View style={{backgroundColor: '#fff', borderRadius: 10, marginTop: 10 }}>
                                <TouchableOpacity activeOpacity={1}
                                    style={{ backgroundColor: !this.state.isGuige ? '#eee' : 'orange', width: '33%', height: height * 0.05, borderRadius: 20, margin: 15, justifyContent: 'center', alignItems: 'center' }}
                            ...
                            <View style={{ backgroundColor: '#fff', borderRadius: 10, marginTop: 10 }}>
                                <TouchableOpacity activeOpacity={1}
                                    style={{ backgroundColor: !this.state.isCailiao ? '#eee' : 'orange', width: '33%', height: height * 0.05, borderRadius: 20, margin: 15, justifyContent: 'center', alignItems: 'center' }}
                      ...
                      <View style={{backgroundColor: '#fff', borderRadius: 10, marginTop: 10, flexDirection: 'row' }}>
                           {
                                    arr.map((v, k) => {
                                        if (k < 3) {
                                            return (<View key={k}
                                                style={{width: width * 0.25, height: width * 0.25, backgroundColor: '#eee', marginTop: 15, marginBottom: 15, marginLeft: 15, borderRadius: 10, alignItems: 'flex-end'}}>
                                                <Image source={{ uri: v }}
                                                    style={{ width: width * 0.25, height: width * 0.25, position: 'relative' }}
                                                    borderRadius={10}/>
                       ...
                       <View style={{backgroundColor: '#fff', borderRadius: 10, marginTop: 10, flexDirection: 'row', justifyContent: 'space-between'}}>
                                <TouchableOpacity activeOpacity={1}
                                    style={{ padding: 2, margin: 11, marginBottom: 13, marginTop: 13, borderRadius: 10, borderWidth: 1, borderColor: this.state.isBaozhuang0 ? 'orange' : 'rgba(0,0,0,0)' }}
                                    onPress={() => this.isBaozhuang(0)}>
                                    <ImageBackground borderRadius={10}
                                        style={{ width: width * 0.25, height: width * 0.25, justifyContent: 'center', alignItems: 'center' }}
                                        source={{ uri: 'https://img0.baidu.com/it/u=3988042386,1218264988&fm=26&fmt=auto&gp=0.jpg' }}>
                                        <Text style={{ color: '#fff'}}>通用包装</Text> 
                                        </ImageBackground> 
                                        </TouchableOpacity>
                                         <TouchableOpacity activeOpacity={1}
                                            style={{ padding: 2, marginTop: 13, marginBottom: 13, borderRadius: 10, borderWidth: 1, borderColor: this.state.isBaozhuang1 ? 'orange' : 'rgba(0,0,0,0)' }}
                                            onPress={() => this.isBaozhuang(1)}>
                                    <ImageBackground borderRadius={10}
                                        style={{ width: width * 0.25, height: width * 0.25, justifyContent: 'center', alignItems: 'center' }}
                                        source={{ uri: 'https://img0.baidu.com/it/u=3988042386,1218264988&fm=26&fmt=auto&gp=0.jpg' }}>
                                        <Text style={{ color: '#fff' }}>礼盒包装+logo</Text>
                                          ...
                                          <TouchableOpacity activeOpacity={1}
                                            style={{ padding: 2, margin: 11, marginBottom: 13, marginTop: 13, borderRadius: 10, borderWidth: 1, borderColor: this.state.isBaozhuang2 ? 'orange' : 'rgba(0,0,0,0)'}}
                                            onPress={ () => this.isBaozhuang(2)}>
                                    <ImageBackground borderRadius={10}
                                        style={{ width: width * 0.25, height: width * 0.25, justifyContent: 'center', alignItems: 'center' }}
                                        source={{ uri: 'https://img0.baidu.com/it/u=3988042386,1218264988&fm=26&fmt=auto&gp=0.jpg' }
                                        } >
                          ...
                          <View style={{ backgroundColor: '#fff', borderRadius: 10, marginTop: 10, flexDirection: 'row', justifyContent: 'space-between' }}>
                                <TouchableOpacity onPress={() => this._year()}
                                    activeOpacity={1}
                                    style={{ backgroundColor: '#eee', width: width * 0.23, height: width * 0.1, margin: 15, flexDirection: 'row', alignItems: 'center', borderRadius: 10 }}>
                                    <View style={{ width: '85%', alignItems: 'center'}}>
                                        <Text>{this.state.year === '' ? '年' : this.state.year} </Text>
                                         </View >
                                          <Text > ▽ </Text>
                                          </TouchableOpacity > 
                                          <TouchableOpacity onPress={() => this._month()}
                                            activeOpacity={1}
                                            style={{ backgroundColor: '#eee', width: width * 0.23, height: width * 0.1, margin: 15, flexDirection: 'row', alignItems: 'center', borderRadius: 10 }}>
                                    <View style={{width: '85%', alignItems: 'center'}}>
                                        <Text>{this.state.month === '' ? '月' : this.state.month}</Text>
                                         ...
                                         <TouchableOpacity onPress={() => this._day()}
                                            activeOpacity={1}
                                            style={{ backgroundColor: '#eee', width: width * 0.23, height: width * 0.1, margin: 15, flexDirection: 'row', alignItems: 'center', borderRadius: 10 }}>
                                    <View style={{ width: '85%', alignItems: 'center'}}>
