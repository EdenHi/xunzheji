...
import {View,TouchableOpacity,Text,Dimensions,ImageBackground,Image, TextInput,ScrollView} from 'react-native';
                ...
                <LinearGradient style={{flex:1}} colors={["#7cc0bf", "#fff", "#fff"]}>
                    ...
                    <ScrollView>
                        ...
                        <View style={{justifyContent:'center',alignItems:'center',width,marginBottom:20}}>
                            <TouchableOpacity activeOpacity={1} style={{justifyContent:'center',alignItems:'center',backgroundColor:'#7cc0c0',borderRadius:30}}>
