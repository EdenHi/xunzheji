...
export default class Exhibition3 extends React.Component {
    ...
    render() {
        return (
            <View >
                <ImageBackground style={{ width: width * 4, height: height * 0.8, elevation: 1, flexDirection: "row", justifyContent: "space-around" }} source={require("../../HomeScreen/photos/祥云3.png")} >
                ...
                <View style={{ width: width * 0.3, height: height * 0.2, elevation: 5, position: "absolute" }}>
                    <Image style={{ width: width * 0.3, height: height * 0.2, marginTop: "450%",marginLeft:"1200%" }} source={require("../../HomeScreen/photos/花卉1.png")} />
                </View>
            </View>
        );
    }
