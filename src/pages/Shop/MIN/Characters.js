            ...
            <View style={{ alignItems: "center" ,flex:1}}>   
               <View style={{ flexDirection: "row",marginBottom:10, width: width * 0.9,height:height*0.17,backgroundColor:"#fff",elevation:5,borderRadius:10 ,alignItems:"center"}}>
                    ...
                    <View style={{marginLeft:20}}>
                        ...
                        <View style={{ width:width*0.25,height:40,borderWidth:1,justifyContent:"center",alignItems:"center",borderRadius:10,borderColor:global.mainColor,marginLeft:"40%",marginTop:-20}}><Text style={{ fontSize: 15 }}>加入咨询</Text></View>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={{ flexDirection: "row",marginBottom:10, width: width * 0.9,height:height*0.17,backgroundColor:"#fff",elevation:5,borderRadius:10 ,alignItems:"center"}}>
