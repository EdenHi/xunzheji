...
import { Image, View, Dimensions, Text, TouchableOpacity, ScrollView,FlatList } from 'react-native'
...
export default class Characters extends Component {
    ...
    renderItem({item,index}){
        return(
            <View style={{ flexDirection: "row",marginHorizontal:width*0.05,marginBottom:10, width: width * 0.9,height:width*0.33,backgroundColor:"#fff",elevation:5,borderRadius:10 ,alignItems:"center"}}>
                <Image style={{ marginLeft:10,width: width * 0.3, height: width * 0.3, borderRadius: 10 }} source={{ uri: item.img[0] }} />
                <View style={{marginLeft:20}}>
                    <View style={{}}><Text style={{ fontSize: 15,fontWeight:"bold" }}>{item.name}</Text></View>
                    <View style={{}}><Text style={{ fontSize: 15,fontWeight:"bold" }}>￥{item.price}</Text></View>
                    <TouchableOpacity onPress={() => this.context.navigate('Zhifu', {price:item.price,name:item.name,pic:item.img})}
                    >
                    <View style={{ width:width*0.25,height:40,borderWidth:1,justifyContent:"center",alignItems:"center",borderRadius:10,borderColor:global.mainColor,marginLeft:"40%",marginTop:-20}}><Text style={{ fontSize: 15 }}>立即购买</Text></View>
                    </TouchableOpacity>
                </View>
            </View>
        )
    ...
    render() {
        ...
        return (
            <View style={{ alignItems: "center" ,height:height,width:width}}>   
                ...
                <FlatList
                style={{width}}
                data={this.state.data[this.props.page].zuopin}
