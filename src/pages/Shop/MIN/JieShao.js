...
import { Dimensions, Image, View, TouchableOpacity, Text, ScrollView, FlatList } from 'react-native'
...
export default class JieShao extends Component {
    ...
    render() {
        return (
            <View style={{flex:1}}>
                <LinearGradient style={{height:'100%',width}} colors={[global.mainColor, "#fff", "#fff"]}>
