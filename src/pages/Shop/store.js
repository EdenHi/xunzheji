      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.input}>
            <View style={{width:width*0.07,marginLeft:"5%",height:width*0.07,backgroundColor:"black"}}></View>
       ...
       <View style={{alignItems:"center",backgroundColor:"#f1f1f1"}}>
        <ImageBackground style={{width:"100%",height:width*0.45}}  >
        <EZSwiper style={ {width: "100%", height: "100%"} }
          ...
          <View style={styles.old}>
            <View style={{width:"100%",height:"12%",alignItems:"center",flexDirection:"row"}}>
              ...
              <TouchableOpacity style={{width:width*0.08,height:width*0.08,backgroundColor:"red",marginLeft:"65%"}}></TouchableOpacity>
            </View>
          ...
          <View style={{width:"100%",height:"12%",alignItems:"center",flexDirection:"row"}}>
              ...
              <TouchableOpacity style={{width:width*0.08,height:width*0.08,backgroundColor:"red",marginLeft:"57%"}}></TouchableOpacity>
            </View>
