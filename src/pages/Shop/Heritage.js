                ...
                {/* <LinearGradient colors={[global.mainColor, '#fff', '#fff']} > */}
                            ...
                            <View style={{ alignItems: "center" }} >
                                ...
                                <View style={{ marginLeft: 10 }} >
                                            ...
                                            <View style={{ flexDirection: "row", marginTop: 15 }} >
                                                <View style={{ width: 70, elevation:5,height: 20, backgroundColor: global.mainColor, borderRadius: 10, marginRight: 10, justifyContent: "center", alignItems: "center" }} > 
                                                <Text style={{ fontSize: 13,color:"#fff" }} >五彩梁弄</Text>
                                                        </View >
                                                <View style={{ width: 70, height: 20, elevation:5, backgroundColor: global.mainColor, borderRadius: 10, marginRight: 10, justifyContent: "center", alignItems: "center" }} > 
                    ...
                    <View style={{ height: height * 0.07, backgroundColor: "#fff",flexDirection: "row", width: width, alignItems: "center",}} >
                            ...
                            <TouchableOpacity onPress={
                                ...
                                activeOpacity={1}
                                style={
                                    { width: width * 0.7, height: height * 0.05,elevation:5, backgroundColor: global.mainColor,marginLeft:width*0.05, justifyContent: "center", alignItems: "center", borderRadius: 20 }} >
                                <Text style={
