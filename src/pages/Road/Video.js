    ...
    render() {
        ...
        return (
            <View style={{ backgroundColor: 'rgb(249,200,159)', flex: 1 }}>
                ...
                <LinearGradient style={{ width }} colors={[global.mainColor, "#fff", global.mainColor]} >
                    <Modal
                        animationType='slide'
                        transparent={true}
                    ...
                    >
                        <View style={{ flex: 1 }}>
                            ...
                            <View style={{ flex: 0.1, backgroundColor: global.mainColor, borderTopRightRadius: 50, borderTopLeftRadius: 50, elevation: 5 }}>
                    ...
                    >
                        ...
                        <View style={{ flex: 1 }}>
                            ...
                            <View style={{ flex: 0.1, backgroundColor: global.mainColor, borderTopRightRadius: 50, borderTopLeftRadius: 50, elevation: 5, flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <TouchableOpacity activeOpacity={1} onPress={() => { this.setModalVisible4(!modalVisible4) }} style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.4)' }}>
                            <View collapsable={false} ref={viewRef} style={{ borderWidth: 1, height: height * 0.83 }}>
                                <ImageBackground resizeMode={'stretch'} style={{ flex: 5, width: '80%', height: height * 0.6, marginLeft: '10%', marginTop: height * 0.15, borderWidth: 0, }} imageStyle={{ width: '100%' }} borderRadius={10} source={require('../img/haibao.png')}>
                                    <View style={{ height: height * 0.08, width: '90%', marginLeft: '4.7%', borderColor: 'red', marginTop: height * 0.42, borderWidth: 0 }}>
                                        <Text style={{marginTop:height*-0.175,color: '#fff', fontSize: 20, fontWeight: 'bold', textAlign: 'center', width: '90%',alignSelf:'center', height: '100%', textAlignVertical: 'center' }}>大约走过{this.state.step}Km，祝你快乐生活每一天</Text>
                                    </View>
                                </ImageBackground>
                            </View>
                                ...
                                <View style={{ borderWidth: 0, flex: 1, flexDirection: 'row', width: '90%', marginLeft: '5%' }}>
                                    ...
                                    <View style={{ width: '33.33333%', height: '100%', borderWidth: 0, }}>
                                        <TouchableOpacity activeOpacity={1} onPress={() => {
                                            ...
                                            ); console.log(this.state.shoturi), this.setModalVisible4(!modalVisible4)
                                        }} style={{ borderWidth: 1, width: height * 0.07, height: height * 0.07, alignSelf: 'center', marginTop: height * 0.02, borderRadius: 100, backgroundColor: '#333333' }}>
                    ...
                    {/* 底部 */}
                    <View style={{ height: height * 0.2, flexDirection: 'row', justifyContent: 'center',alignItems:"center" ,marginTop:20}}>
