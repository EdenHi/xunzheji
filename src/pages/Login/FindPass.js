      ...
      <View style={{ flex: 1, backgroundColor: "" }}>
        ...
        <View style={{ flex: 2, borderWidth: 0, justifyContent: "space-between", flexDirection: 'column-reverse' }}>
          ...
          <View style={{ marginBottom: height * 0.03 }}>
            <Text style={{ fontSize: ratio_w * 30, borderWidth: 0, textAlign: "center", marginBottom: height * 0.01, color: global.mainColor }} allowFontScaling={false}>找回密码</Text>
        ...
        <View style={{ flex: 3 }}>
          ...
          <TouchableOpacity style={styles.btn} onPress={() => { this.props.navigation.navigate('BtnRoute') }} >
            <ImageBackground borderRadius={20} style={{ height: "100%", width: "100%",backgroundColor:global.mainColor,borderRadius:20,elevation:5}}>
