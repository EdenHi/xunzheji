    ...
    render() {
        return (
            <View style={{flex:1}}>
                ...
                <TouchableOpacity onPress={()=>{this.go_tuijian(),this.props.navigation.navigate('BtnRoute')}} style={{backgroundColor:'#7cc0c0',width:width*0.5,marginHorizontal:width*0.25,justifyContent:'center',alignItems:'center',borderRadius:30,marginVertical:10}} activeOpacity={1}>
