    ...
    render() {
        ...
        return (
            <View style={{flex:1,backgroundColor:'#fff'}}>
                ...
                <TouchableOpacity onPress={()=>{this.go_nickname(),this.updateSex(),this.props.navigation.navigate('Register_tuijian')}} style={{backgroundColor:global.mainColor,width:width*0.5,marginHorizontal:width*0.25,justifyContent:'center',alignItems:'center',borderRadius:30}} activeOpacity={1}>
