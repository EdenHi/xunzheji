            ...
            <View>
                ...
                <View style={{flexDirection:"row",alignItems:"center",height:height*0.07,backgroundColor:"#fff"}}> 
                    ...
                    <View style={{width:width*0.85,marginLeft:"2%",alignItems:'center'}}>
                        <Text style={{fontSize:15,fontWeight:"bold",color:"#000"}}>选择话题</Text>
                    </View>
                </View> 
                <ScrollView
                ...
                showsVerticalScrollIndicator={false}>
                    ...
                    onPress={()=>this.props.navigation.navigate('Fabu',{tag:'圣诞COS'})}>
                        <Image source={{uri:'https://img1.baidu.com/it/u=838322116,2644852131&fm=26&fmt=auto&gp=0.jpg'}} style={{height:width*0.25,width:width*0.25,borderRadius:10}}/>
                    ...
                    <TouchableOpacity style={{marginTop:10,flexDirection:'row',alignItems:'center' }} activeOpacity={1}
                     onPress={()=>this.props.navigation.navigate('Fabu',{tag:'猫和老鼠'})}>
                        <Image source={{uri:'https://img1.baidu.com/it/u=838322116,2644852131&fm=26&fmt=auto&gp=0.jpg'}} style={{height:width*0.25,width:width*0.25,borderRadius:10}}/>
                        <View style={{marginLeft:20}}>
                    ...
                    <TouchableOpacity style={{marginTop:10,flexDirection:'row',alignItems:'center' }} activeOpacity={1}
                    onPress={()=>this.props.navigation.navigate('Fabu',{tag:'lolita'})}>
                        <Image source={{uri:'https://img1.baidu.com/it/u=838322116,2644852131&fm=26&fmt=auto&gp=0.jpg'}} style={{height:width*0.25,width:width*0.25,borderRadius:10}}/>
                        <View style={{marginLeft:20}}>
                    ...
                    <TouchableOpacity style={{marginTop:10,flexDirection:'row',alignItems:'center' }} activeOpacity={1}
                    onPress={()=>this.props.navigation.navigate('Fabu',{tag:'新年祝福姬'})}>
                        <Image source={{uri:'https://img1.baidu.com/it/u=838322116,2644852131&fm=26&fmt=auto&gp=0.jpg'}} style={{height:width*0.25,width:width*0.25,borderRadius:10}}/>
                        <View style={{marginLeft:20}}>
                    ...
                    <TouchableOpacity style={{marginTop:10,flexDirection:'row',alignItems:'center' }} activeOpacity={1}
                    onPress={()=>this.props.navigation.navigate('Fabu',{tag:'动漫嘉年华'})}>
                        <Image source={{uri:'https://img1.baidu.com/it/u=838322116,2644852131&fm=26&fmt=auto&gp=0.jpg'}} style={{height:width*0.25,width:width*0.25,borderRadius:10}}/>
                        <View style={{marginLeft:20}}>
                    ...
                    <TouchableOpacity style={{marginTop:10,flexDirection:'row',alignItems:'center' }} activeOpacity={1}
                    onPress={()=>this.props.navigation.navigate('Fabu',{tag:'漫展返图'})}>
                        <Image source={{uri:'https://img1.baidu.com/it/u=838322116,2644852131&fm=26&fmt=auto&gp=0.jpg'}} style={{height:width*0.25,width:width*0.25,borderRadius:10}}/>
                        <View style={{marginLeft:20}}>
                    ...
                    <TouchableOpacity style={{marginTop:10,flexDirection:'row',alignItems:'center' }} activeOpacity={1}
                    onPress={()=>this.props.navigation.navigate('Fabu',{tag:'凉宫春日'})}>
                        <Image source={{uri:'https://img1.baidu.com/it/u=838322116,2644852131&fm=26&fmt=auto&gp=0.jpg'}} style={{height:width*0.25,width:width*0.25,borderRadius:10}}/>
                        <View style={{marginLeft:20}}>
