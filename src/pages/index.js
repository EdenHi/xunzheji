...
export {default as CustormerBar} from './Forum/CustormerBar'; //论坛列表
//export {default as Forum} from './Forum/Luntan.js'; //论坛列表
export {default as Comment} from './Forum/comment'; //论坛内容
export {default as Comment_huifu} from './Forum/comment_huifu'; //论坛回复
export {default as Fabu} from './Forum/fabu'; //论坛发布动态
...
export {default as ForumTop} from './Forum/ForumTop';
